...
urlpatterns = [
    ...
    # Login and Logout paths with templates
    path('', LoginView.as_view(template_name='user/login.html'), name='user-login'),
    path('logout/', user_views.logout_view, name='user-logout'),

    # Dashboard and user-related paths
    path('', include('dashboard.urls')),  # Dashboard app URLs
